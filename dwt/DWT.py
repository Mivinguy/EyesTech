...
synthBandL = np.zeros(((originalRow+1)%2 + originalRow, originalCol//2+1), dtype = np.int8)
...
synthBandH = np.zeros(((originalRow+1)%2 + originalRow, originalCol//2+2), dtype = np.int8)
...
print(bandLL, bandHH, bandHL, bandLH)
